    ...
    //program
        ...
        //to enter a choice if the entry is invalid
         ...
         while (continueInput) {
     	  	...
     	  	std::cout << "Enter a selection (1 through 6): " << std::endl;
  ...
  /*
	...
	case 5:
	   ...
	   if(minPathTrip.size()>0) {
            ...
            {
		curr=getDistance (minPathTrip[i]->getLatitude(),minPathTrip[i]->getLongitude(),
